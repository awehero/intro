var map = {
    ...
    reset: function() {
        ...
        //Skeeball
        a.re('P42', [0.00014, 0.00014, -189.99986], [0, 0, 0], [8, 0.5, 2]);
        a.re('P43', [0.00021, 0.00021, -200.99979], [0, 0, 0], [8, 0.5, 20]);
        a.re('P44', [0.00028, 0.10028, -211.29972], [0, 0.1, 0], [8, 0.5, 2]);
        a.re('P45', [0.00035, 0.20035, -211.49965], [0, 0.21, 0], [8, 0.5, 2]);
        a.re('P46', [0.00042, 0.30042, -211.69958], [0, 0.31, 0], [8, 0.5, 2]);
        a.re('P47', [0.00049, 0.40049, -211.89951], [0, 0.42, 0], [8, 0.5, 2]);
        a.re('P48', [0, 0.5, -212.1], [0, 0.52, 0], [8, 0.5, 2]);
        //Ending
