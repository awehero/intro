var map = {
        ...
        if (currentGame == "skeeball") {
            ...
            case 2:
                ...
                if (PZ < -191.5) {
                    var ImpulseVector = gravity;
                    ImpulseVector = ImpulseVector.scale(ImpulseMagnitude);
                    ImpulseVector.z += (-2 * (powercatch + 3)) - 8;
    ...
    reset: function() {
        ...
        a.re('P51', [2.50028, -0.02972, -191.89972], [0, 0, 0], [1, 0.5, 1.8]);
        a.re('P52', [1.50035, -0.02965, -191.79965], [0, 0, 0], [1, 0.5, 1.6]);
        a.re('P53', [-3.49958, -0.02958, -191.29958], [0, 0, 0], [1, 0.5, 0.6]);
        a.re('P54', [-2.49951, -0.02951, -191.39951], [0, 0, 0], [1, 0.5, 0.8]);
        a.re('P55', [-1.5, -0.03, -191.5], [0, 0, 0], [1, 0.5, 1]);
        a.re('P56', [-0.49993, -0.02993, -191.59993], [0, 0, 0], [1, 0.5, 1.2]);
        a.re('P57', [0.50014, -0.02986, -191.69986], [0, 0, 0], [1, 0.5, 1.4]);
        //Ending
