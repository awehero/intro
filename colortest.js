var map = {
    ...
    post: function() {
        ...
        cc.set_monkey("light.intensity", 10000000);
        cc.set_monkey("light.specular", new BABYLON.Color3.FromHexString("#00000a"));
        cc.set_monkey("light.diffuse", new BABYLON.Color3.FromHexString("#00ffff"));
        cc.set_monkey("light.diffuse", new BABYLON.Color3.FromHexString("#ff0000"));
        cc.set_monkey("light.diffuse", new BABYLON.Color3.FromHexString("#ffff00"));
    ...
    reset: function() {
        ...
        a.re('C18', [5.21, 0.85, -23.4], [0, 0, 0], [2, 2, 2]);
        a.re('C19', [1.97, 0.85, -18.35], [0, 0, 0], [2, 2, 2]);
        a.re('E0', [-33.5, 2, -213], [0, 0, 0], [1, 1, 1]);
    },
